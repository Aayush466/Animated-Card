...
const CardsData = [
  {
    ...
    img: Photo1,
    title: "Sunset",
    desc: "Sunsets, like childhood, are viewed with wonder not just because they are beautiful but because they are fleeting.",
    // aa
  },
  {
    id: 2,
    img: Photo2,
    title: "Dog",
    desc: "Money can buy you a fine dog, but only love can make him wag his tail.",
  },
  {
    id: 3,
    img: Photo3,
    title: "Sunrise",
    desc: "Sunrise, the miracle of the day",
  },
];
const AnimatedCard = () => {
  return (
    <div className="container mx-auto">
      <h1 className="text-center text-red font-bold text-3xl mb-14 mt-5 sm:mt-0">
